...
class _DesktopScreenState extends State<DesktopScreen> {
  ...
  _buildHeader() => Padding(
        padding: EdgeInsets.symmetric(
            horizontal: c.h(context) * 0.01, vertical: c.h(context) * 0.01),
        child: Container(
          // height:,
          // color: Colors.amber,
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                const SizedBox(
                    child: Icon(Icons.menu, color: Color.fromARGB(170, 0, 0, 0))),
                // SizedBox(
                //   width: c.w(context) * 0.6 ,
                // ),
                SizedBox(
                  child: Row(
                    children: [
                ...
                LayoutBuilder(builder: (context, constraints) {
                  ...
                  return GridView.builder(
                    ...
                    gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
                      ...
                      childAspectRatio:
                          crossAxisCount == 2 ? 2.5 : 1.6, // Adjust as needed
                    ),
 ...
 _buildCard(String name, IconData icon, String price, String hike, Color col,
              ...
              Row(
                ...
                children: [
                  Row(
                   ...
                   Icon(Icons.more_vert , size: c.h(context) * 0.03),
                ],
              ),
  ...
  _buildRepeatCustomerrate() => Expanded(
        child: Padding(
          padding: EdgeInsets.symmetric(vertical: c.h(context) * 0.01),
          child: Container(
            // height: c.h(context) * 0.56,
  ...
  _buildProjectOverview() => Expanded(
        child: Padding(
